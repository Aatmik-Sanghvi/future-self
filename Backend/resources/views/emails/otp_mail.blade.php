...
<head>
    ...
    <style>
        ...
        @media only screen and (max-width: 600px) {
            ...
            .email-card { padding: 32px 24px !important; border-radius: 16px !important; }
            .otp-code { font-size: 32px !important; letter-spacing: 10px !important; padding: 20px 24px !important; }
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #0a0a1a;">
        <tr>
            <td align="center" style="padding: 40px 16px;">
                ...
                <!-- Container -->
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" class="email-container" style="max-width: 520px; width: 100%;">
                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 32px;">
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="width: 120px; height: 4px; border-radius: 4px; background: linear-gradient(90deg, #7c3aed, #8b5cf6, #a78bfa);"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td align="center" style="padding-bottom: 8px;">
                                        <h1 class="email-heading" style="margin: 0; font-size: 26px; font-weight: 800; color: #f0eef6; letter-spacing: -0.03em; line-height: 1.2;">
                                            Verification Code
                                        </h1>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td style="padding-bottom: 28px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="height: 1px; background: linear-gradient(90deg, transparent, rgba(139, 92, 246, 0.15), transparent);"></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
